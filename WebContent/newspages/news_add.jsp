...
<div id="admin_bar">
  <div id="status">管理员： <%=session.getAttribute("loginUser") %>  &#160;&#160;登录  &#160;&#160;&#160;&#160;<a href="#">login out</a></div>
  <div id="channel"> </div>
</div>
<div id="main">
  <div id="opt_list">
  ...
  <div id="opt_area">
    ...
    <form action="" method="post">
      <p>
        <label>主题    </label>
        <select name="ntid" style="width: 200px">
          ...
          <%
           ...
           list =  db.findMultiObject(sql, null);
            for(int i = 0; i<list.size();i++){%>
        	 <option value='<%=list.get(i).get("TID") %> '><%=list.get(i).get("TNAME") %> </option> 
        <% }
        %>
        </select>
      </p>
